...
{
    internal partial class FindFilmView : Form
    {
        ...
        private void FindButtonClick(object sender, EventArgs e)
        {
            ...
            SearchDescriptor searchDescriptor = MakeSearchDescriptor();

            EventHandler searchDescriptorCompleted = SearchDescriptorCompleted;
            if (searchDescriptorCompleted != null)
            {
                searchDescriptorCompleted(this, new SearchDescriptorEventArgs(searchDescriptor));
            }
        }
