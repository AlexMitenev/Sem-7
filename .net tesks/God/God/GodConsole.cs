...
namespace God
{
    internal sealed class GodConsole
    {
        ...
        public void Run()
        {
            ...
            Console.WriteLine("Добрый день. Вы используете консоль бога. Сколько людей вы хотите сотворить?");
            ...
            for (var i = 0; i < humansCount; i++)
            {
                ...
                if (i == 0)
                {
                    human = _god.CreateHuman(Sex.Man);
                }
                else if (i == 1)
                {
                    human = _god.CreateHuman(Sex.Woman);
                }
                else
                {
