...
Data_set from http://labrosa.ee.columbia.edu/millionsong/tasteprofile
================================"""
print "Parameters:"

Good_N_of_similars = 11
count_of_loading_users = 100
filtering_count_of_plays = 51

load_data_into_M(count_of_loading_users, filtering_count_of_plays)

print "Count of similars for each user = " + str(Good_N_of_similars)
print "Count of plays for filtering each user = " + str(filtering_count_of_plays)
print "Count of unique user  = " + str(len(all_users()))
...
t1 = time.time()
learning(Good_N_of_similars)
t2 = time.time()
print "Time = " + strtimedelta(t1, t2)
print "============End learning================="

print "============Start RMSE counting============="
t1 = time.time()
print "RMSE = " + str(RMSE())
t2 = time.time()
print "Time = " + strtimedelta(t1, t2)
print "============End RMSE counting==============="
